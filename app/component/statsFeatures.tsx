        ...
        <div className="mx-auto max-w-360 px-10">
            ...
            <section>
                <div className="flex flex-col items-center justify-center ">
                    ...
                    <Button
                        onClick={() => (window.location.href = '/our-methods')}
                        variant="secondary"
                    >
                        Our Methods
                    </Button>
                ...
                <div className="mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
                        ...
                        <div className="space-y-6 lg:sticky lg:top-30 self-start h-fit">
                            ...
                            <h2 className="text-4xl font-serif leading-tight">Natural Integrity</h2>

                            <p className="text-neutral-600 max-w-md">
                                Built with responsibly sourced components and clean design
                                principles, it blends function, form, and sustainability
                            </p>
                        </div>
                ...
                <div className="mx-auto py-14">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
                        ...
                        <div className="space-y-6 lg:sticky lg:top-30 self-start h-fit">
                            ...
                            <h2 className="text-4xl font-serif leading-tight">Conscious Design</h2>

                            <p className="text-neutral-600 max-w-md">
                                Made using durable, low-impact materials, this piece is as mindful
                                as it is beautifully made—designed to last and leave a lighter
                                footprint
                            </p>
                        </div>
