    ...
    <Link href={href} className="block">
      ...
      >
        ...
        <div className="p-4 space-y-3">
          ...
          <span className="inline-flex items-center justify-center rounded-full w-full border border-neutral-300 bg-white px-4 py-2 text-sm font-medium text-neutral-900 transition group-hover:bg-neutral-900 group-hover:text-white ease-in-out duration-500">
            View Product
          </span>
        </div>
      </motion.div>
