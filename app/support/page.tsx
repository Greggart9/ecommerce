...
const SupportPage = () => {
  return (
    <div className="flex flex-col items-center justify-center px-10 w-full pt-35">
        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_1.5fr]">
          ...
          <div className="rounded-lg border bg-neutral-100 p-8 shadow-sm">
            <div className="space-y-1">
              <h2 className="text-2xl font-serif font-semibold text-black">Drop Us a Line</h2>
              <p className="text-base text-neutral-500">We&apos;re here and ready to listen!</p>
            </div>

            <form className="mt-6 space-y-10 ">
              <div className="space-y-4">
                <label className="text-base font-medium text-neutral-700">Request</label>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-4">
                  <label className="text-base font-medium text-neutral-700">Full name</label>
                  <input
                    type="text"
                ...
                <div className="space-y-4">
                  <label className="text-base font-medium text-neutral-700">Phone number</label>
                  <input
                    type="tel"
              ...
              <div className="space-y-4">
                <label className="text-base font-medium text-neutral-700">Email address</label>
                <input
                  type="email"
              ...
              <div className="space-y-4">
                <label className="text-base font-medium text-neutral-700">Message</label>
                <textarea
                  rows={4}
